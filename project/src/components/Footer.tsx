      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <motion.div 
            ...
            className="space-y-4"
          >
            <h3 className="text-2xl font-bold mb-4">Maa Asho Devi</h3>
            ...
            <div className="flex space-x-4 mt-6">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="bg-yellow-600 p-2 rounded-full hover:bg-yellow-700 transition-colors"
              >
          ...
          >
            ...
            <div className="space-y-3">
              <div className="flex items-start">
                ...
                <p className="text-gray-400">123 Spiritual Avenue, Delhi, India - 110001</p>
              </div>
              ...
              <div className="flex items-center">
                ...
                <p className="text-gray-400">info@maaashodevi.com</p>
              </div>
