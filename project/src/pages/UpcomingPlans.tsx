  ...
  const upcomingTrips = [
    {
      ...
      availableSeats: 15,
      featured: true,
      description: 'Complete pilgrimage to the four sacred sites of Yamunotri, Gangotri, Kedarnath, and Badrinath in the Himalayas.'
    },
    {
      id: 2,
    ...
    {
      id: 3,
      title: 'Jagannath Puri & Konark Sun Temple',
      image: 'https://images.unsplash.com/photo-1518002054494-3a6f94352e9d?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80',
