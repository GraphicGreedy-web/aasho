    ...
    <PageTransition>
      <div className="min-h-screen bg-gray-50 py-20">
        <div className="container mx-auto px-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        {post.author} is an experienced travel writer specializing in spiritual journeys across India. 
                        With a deep understanding of Hindu traditions and sacred sites, they bring authentic insights 
                        to their writing about pilgrimage destinations.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="lg:col-span-1">
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
                ...
                <ul className="space-y-2">
                  <li>
                    <Link to="/blog" className="flex justify-between items-center text-gray-600 hover:text-primary transition-colors">
                      <span>All</span>
                  ...
                  <li>
                    <Link to="/blog" className="flex justify-between items-center text-gray-600 hover:text-primary transition-colors">
                      ...
                      <span className="bg-gray-100 text-gray-700 px-2 py-1 rounded-full text-xs">
                        {blogPosts.filter(p => p.category === 'Destinations').length}
                      </span>
                    </Link>
                  </li>
                  <li>
                    <Link to="/blog" className="flex justify-between items-center text-gray-600 hover:text-primary transition-colors">
                      ...
                      <span className="bg-gray-100 text-gray-700 px-2 py-1 rounded-full text-xs">
                        {blogPosts.filter(p => p.category === 'Travel Tips').length}
                      </span>
                    </Link>
                  </li>
                  <li>
                    <Link to="/blog" className="flex justify-between items-center text-gray-600 hover:text-primary transition-colors">
                      <span>Mythology</span>
                      <span className="bg-gray-100 text-gray-700 px-2 py-1 rounded-full text-xs">
                        {blogPosts.filter(p => p.category === 'Mythology').length}
                      </span>
                    </Link>
                  </li>
                  <li>
                    <Link to="/blog" className="flex justify-between items-center text-gray-600 hover:text-primary transition-colors">
                      ...
                      <span className="bg-gray-100 text-gray-700 px-2 py-1 rounded-full text-xs">
                        {blogPosts.filter(p => p.category === 'Personal Stories').length}
                      </span>
                    </Link>
                  </li>
                  <li>
                    <Link to="/blog" className="flex justify-between items-center text-gray-600 hover:text-primary transition-colors">
                      <span>Culture</span>
                      <span className="bg-gray-100 text-gray-700 px-2 py-1 rounded-full text-xs">
                        {blogPosts.filter(p => p.category === 'Culture').length}
                      </span>
                    </Link>
                  </li>
                  <li>
                    <Link to="/blog" className="flex justify-between items-center text-gray-600 hover:text-primary transition-colors">
                      <span>Festivals</span>
                      <span className="bg-gray-100 text-gray-700 px-2 py-1 rounded-full text-xs">
                        {blogPosts.filter(p => p.category === 'Festivals').length}
                      </span>
                    </Link>
                  </li>
                </ul>
              ...
              <div className="bg-primary/5 rounded-xl shadow-lg p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Get the latest updates on spiritual journeys and travel tips delivered to your inbox.
                </p>
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold mb-4">Ready to Experience These Sacred Journeys?</h2>
